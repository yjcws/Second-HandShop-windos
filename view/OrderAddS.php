...
//    $helper->dd($_POST);
    ...
    $Cart['picurl']=$_POST['picurl'];
    $Cart['title']=$_POST['title'];
    $Cart['Price']=$_POST['price'];
    $Cart['CartTotal']=$_POST['num'];
    $Cart['numbers']=$_POST['numbers'];
    $Cart['xiaoji']=$Cart['Price']*$Cart['CartTotal'];
    $Cart['youhui']=$_POST['youhui'];
    $Cart['youfei']=$_POST['youfei'];
...
<!--              数据传输  -->
                ...
                <input name="CartTotal" type="hidden" id="CartTotal" size="30" value="<?php echo $Cart['CartTotal'];?>"/>
<!--                <input name="xiaoji" type="hidden" id="xiaoji" size="30" value="--><?php //echo $Cart['xiaoji'];?><!--"/>-->
<!--                <input name="picurl" type="hidden" id="picurl" size="30" value="--><?php //echo $Cart['picurl'];?><!--"/>-->
                <table width="100%" border="0" cellspacing="0">
                    <tr>
            ...
            <!--            结算信息-->
                <table width="100%" border="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td height="40">&nbsp;</td>
                        <td height="40">&nbsp;</td>
                        <td height="40" width="20%" colspan="2">应付金额:<font color="red" size="5">￥:<?php echo sprintf("%.2f",$Cart['xiaoji']+$Cart['youfei']-$Cart['youhui']);?></font></td>
                    </tr>
                </table>
            <!--订单留言-->
                <table width="100%" border="0" cellspacing="0">
    ...
    $(function () {
        ...
        $('#orderOK').click(function(){
            ...
            jQuery.ajax({
                ...
                type:"POST",
                data:$('#formOrder').serialize()+"&tab=OrderAddS",
                success:function(data){
                    switch (data) {
                        case '0':
                            alert('支付失败！');
