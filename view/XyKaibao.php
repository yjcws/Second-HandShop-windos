...
<div style="background-color:#f1f1f1;">
    <div class="main">
        <a href="XyKaibao.php"><font size="5" >校园快报</font></a>&nbsp;&nbsp;&nbsp;
    ...
    <div class="main">
        <div style="width: 79%;height: 100%;float: left">
            ...
            <table width="100%" border="0" cellspacing="0"  bgcolor="#FFFFFF"">
                <tr>
                    <th width="253" height="155" rowspan="3" align="center" valign="middle" scope="col"><img src="./image/a<?php echo rand(1,7).'.png';?>" width="253" height="155"></th>
