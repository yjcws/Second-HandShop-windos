...
<div style="background-color:#f1f1f1;">
    <div class="main">
        ...
        <a href="XyTiezi.php"><font size="3" >校园帖子</font></a>  &nbsp;&nbsp;&nbsp;
        <a href="XyRm.php"><font size="5" >热门活动</font></a>&nbsp;&nbsp;&nbsp;
        <hr size="1" noshade>
    </div>
        ...
        <div style="width: 79%;height: 100%;float: left">
            ...
            <table width="100%" border="0" cellspacing="0"  bgcolor="#FFFFFF"">
                <tr>
                    ...
                    <th height="40" colspan="2" align="left" scope="col">&nbsp;&nbsp;<a href="XyRmInfo.php?id=<?php echo $val['id'];?>"><?php echo $val['title'];?></a></th>
                </tr>
                <tr>
...
<!--                <tr>-->
<!--                    <td height="28" align="center"><a href="RmArticleInfo.php?id=--><?php //echo $val['id'];?><!--">--><?php //echo $helper->GetstrLeft($val['title'],10);?><!--</a></td>-->
<!--                </tr>-->
<!--                --><?php //}?>
<!---->
<!---->
