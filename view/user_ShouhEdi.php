...
<!--            <div style="float: right;margin-bottom: 10px"><a href="">添加新的收货地址</a> </div>-->
            ...
            <form id="form1" name="form1" method="post" action="../public/UserLogin.class.php?tab=ShdzEdi&id=<?php echo $id;?>" onsubmit="return test();">
                <table width="100%" height="280" border="0" cellspacing="0" id="form1"  style="border:1px solid #cccccc">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td height="35"><input name="shr" type="text" id="shr" size="30" value="<?php echo $SaRestful['shren']?>" /></td>
                    </tr>
                    <tr>
                        <td height="35" align="center" valign="middle">收货地址：</td>
                        <td height="35"><input name="shdizhi" type="text" id="shdizhi" size="30"  value="<?php echo $SaRestful['shdizhi']?>"/></td>
                    </tr>
                    <tr>
                        <td height="35" align="center" valign="middle">邮编：</td>
                        <td height="35"><input name="youbian" type="text" id="youbian" size="30" value="<?php echo $SaRestful['youbian']?>"/></td>
                    </tr>
                    <tr>
                        <td height="35" align="center" valign="middle">固定电话 ：</td>
                        <td height="35"><input name="tel" type="text" id="tel" size="30" value="<?php echo $SaRestful['tel']?>"/>
                            ＊可以不填</td>
                    </tr>
                    <tr>
                        ...
                        <td height="35">
                            ...
                            <?php }else{?>
                                <input name="is_mr" type="radio" value="1" />
                                是
                                <input type="radio" name="is_mr" value="0" />
                                否</td>
                            <?php }?>
                    ...
                    <tr>
                        ...
                        <td height="35"><input name="mobile" type="text" id="mobile" size="30" value="<?php echo $SaRestful['mobile']?>"/></td>
                    </tr>
                    <tr>
                        <td height="35">&nbsp;</td>
