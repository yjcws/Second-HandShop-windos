...
$id = @$_GET['id'];
if (!empty($id)){
    $OrderInfo = $_SESSION['productOrder'][$id];
...
<!--收货地址-->
            ...
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr>
                    <td width="2%">&nbsp;</td>
                    <td width="87%" height="40"><font color="gray">支付方式：</font><?php echo $OrderInfo['payment'];?></td>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td height="40"><font color="gray">送货时间：</font><?php echo $OrderInfo['songhu'];?></td>
                    <td height="40" >&nbsp;</td>
                </tr>
            </table>
            <!--            商品详情-->
    ...
    " >商品名称</td>
                ...
                <tr>
                    ...
                    <td rowspan="2" align="center" valign="middle"><a href="ShopInfo.php?id=<?php echo $OrderInfo['shopid'];?>"><?php echo $OrderInfo['title'];?></a></td>
                    <td rowspan="2" align="center" valign="middle">￥:<font color="red"><?php if (!empty($OrderInfo['price'])){echo $OrderInfo['price'];}else{echo $OrderInfo['Price'];}?></font></td>
                    <td rowspan="2" align="center" valign="middle">￥:<font color="red"><?php if (!empty($OrderInfo['total']*$OrderInfo['price'])){echo $OrderInfo['total']*$OrderInfo['price'];}else{ echo $OrderInfo['xiaoji'];};?></font></td>
                    <td rowspan="2" align="center" valign="middle"><?php if (!empty($OrderInfo['total'])){echo $OrderInfo['total'];}else{echo $OrderInfo['CartTotal'];}?></td>
                    <?php
                    }else{
                        echo "<tr>
    ...
    ";
            ...
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr>
                    <td width="50%" height="40" align="right">商品件数:<font color="gray"><?php if (!empty($OrderInfo['total'])){echo $OrderInfo['total'];}else{echo $OrderInfo['CartTotal'];}?></font>件</td>
                    <td width="17%" height="40" align="center">商品金额:<font color="gray">￥:<?php if (!empty($OrderInfo['price'])){echo $OrderInfo['price'];}else{echo $OrderInfo['Price'];}?></font></td>
