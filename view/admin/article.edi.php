...
<?php
    ...
    $ArticleRestful = $helper->getOne($ArticleWhere);

    //var_dump($ArticleRestful['content']);
...
<!--../../public/Aticle.class.php-->
        ...
        <form action="../../public/Admin/Aticle.class.php?tab=articleEdi&id=<?php echo $id;?>" method="post" name="myform" onSubmit="return test();">
            <fieldset>
                <legend>文章信息:</legend>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td  width="30%"><input type="text" name="title" size="30" value="<?php echo $ArticleRestful['title'];?>"></td>
                        ...
                        <td  width="30%">
                            ...
                            <select name="typeid">
                                ...
                                <?php foreach ($UserRestful as $k => $v){
                                    if ($v['id']== $ArticleRestful['typeid']){
                                        echo " <option value='{$v['id']}'  selected>{$v['typename']}</option>";
                                    }else{
                    ...
                    <tr>
                        ...
                        <td  width="30%">
                            ...
                            <input type="text" name="author" size="30" value="<?php echo $ArticleRestful['author'];?>">
                        </td>
                        <td bordercolor="#F0F0F0" bgcolor="#F0F0F0" width="32%" height="30" align="right">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td  width="30%"><input type="text" name="com" size="30" value="<?php echo $ArticleRestful['com'];?>"></td>
                        <td bordercolor="#F0F0F0" bgcolor="#F0F0F0" width="32%" height="30" align="right">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td  width="30%">
                            <input type="radio" name="issh" value="1" <?php if ($ArticleRestful['issh']==1){echo 'checked';}?>>审核
                            <input type="radio" name="issh" value="0" <?php if ($ArticleRestful['issh']==0){echo 'checked';}?>>未审核
                        </td>
                        <td bordercolor="#F0F0F0" bgcolor="#F0F0F0" width="32%" height="30" align="right">&nbsp;</td>
...
<!--                        <td  width="30%"><input type="text" name="hits" size="30" value="--><?php //echo $ArticleRestful['hits'];?><!--"></td>-->
<!--                        <td bordercolor="#F0F0F0" bgcolor="#F0F0F0" width="32%" height="30" align="right">&nbsp;</td>-->
<!---->
<!--                    </tr>-->
                    <tr>
<!--                      合并单元格2列：colspan="2"  -->
                        ...
                        <td  width="60%" colspan="2">
                            <textarea  id="container" name="content" rows="10" cols="30" >
                                <?php echo $ArticleRestful['content'];?>
                            </textarea>
