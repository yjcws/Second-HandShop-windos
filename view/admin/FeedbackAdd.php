...
?>
    ...
    <div id="content_body">
        ...
        <fieldset style="border-radius:5px;" >
            <form id="myform" name="myform" method="post" action="../../public/Admin/FeedBack.class.php?tab=FbAdd" onsubmit="return test()">
                <table width="100%" border="0" cellspacing="0" >
                    ...
                    <tr>
                        ...
                        <td height="30" bordercolor="#000000"><label>
                                <input type="radio" name="ishf" value="0" />
                                待回复
                                <input type="radio" name="ishf" value="1" />
                                已回复</label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td height="30" bordercolor="#000000"><label>
                                <textarea name="recontent" cols="60" rows="10" id="recontent"></textarea>
                            </label></td>
                    </tr>
                    <tr>
