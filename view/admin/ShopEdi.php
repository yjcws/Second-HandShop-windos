...
<!--../../public/Aticle.class.php-->
        <div class="body-center"> <font style="margin-left: 50px" size="5">当前位置 >> 修改新商品</font></div>
        <hr>
        <form action="../../public/Admin/Shop.class.php?tab=ShopEdi
            ...
            <fieldset>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="30" colspan="2"><label>
                                <input type="radio" name="issh" value="0"<?php if($ShopEdiRes['issh']==0) echo 'checked';?>>未审核
                                <input type="radio" name="issh" value="1"<?php if($ShopEdiRes['issh']==1) echo 'checked';?>>已审核
                            </label>
                            　　<span class="STYLE3" style="color:#666666;">　　　　　　　&nbsp;商品的状态</span></td>
                    </tr>
                    <tr>
