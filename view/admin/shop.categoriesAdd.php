...
<div id="content_body">
        ...
        <div class="body-center"> <font style="margin-left: 50px" size="5">当前位置 >> 添加商品分类</font></div>
    <hr>

    <form action="../../public/Admin/ShopCategories.class.php?tab=scAdd" method="post" name="myform" onSubmit="return test();">
            <fieldset>
<!--                <legend>分类信息:</legend>-->
