...
<div id="content_body">
    ...
    <fieldset style="border-radius:5px;" >
        <form id="myform" name="myform" method="post" action="../../public/Admin/FeedBackType.class.php?tab=FbEdi" onSubmit="return test()">
            <table width="100%" border="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="85%" height="30" bordercolor="#000000"><label>
                            ...
                            <input name="id" type="hidden" id="id" size="30" value="<?php echo @$_GET['id'];?>"/>
                </tr>
                <tr>
                    <td height="30" align="right" valign="middle" bordercolor="#000000">分类排序 ：</td>
                    <td height="30" bordercolor="#000000"><label>

                         <input name="typeorder" type="text" id="typeorder" size="30"  />                            　

                        <span class="STYLE4" style="color: #5c6370">默认显示最大排序</span></label></td>

                </tr>
                <tr>
                    <td height="30" align="right" valign="middle" bordercolor="#000000">显示状态：</td>
                    <td height="30" bordercolor="#000000"><label>
                            <input type="radio" name="typezt" value="1" <?php if($Order['typezt']==0) echo "checked";?>/>
                            开启
                            <input type="radio" name="typezt" value="0" <?php if($Order['typezt']==0) echo "checked";?>/>
                            关闭
                </tr>
                <tr>
