...
<?php
    ...
    $LinkRestful = $helper->getOne($LinkWhere);
   ...
   // var_dump($LinkRestful);
    ...
    <div id="content_body">
        ...
        <hr>
        <form width="100%" action="../../public/Admin/Links.class.php?id=<?php echo $LinkRestful['id']?>&tab=linksEdit" method="post" enctype="multipart/form-data" name="links" id="links" onsubmit="return test();">
                ...
                <table width="100%" height="40%" border="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th height="35" align="center" scope="col"><label>
                                <input type="radio" name="styleid" id="styleid" value="1"
                                        <?php
                                            if($LinkRestful['styleid']==1)
                                            {
                    ...
                    <tr>
                        ...
                        <td width="347" height="35" align="center"><label>
                                <input name="webname" type="text" value="<?php echo $LinkRestful['webname'];?>" size="40" />
                            </label></td>
                    ...
                    <tr>
                        ...
                        <td width="347" height="35" align="center"><label>
                                <input name="weburl" type="text" size="40" value="<?php echo $LinkRestful['weburl'];?>"/>
                            </label></td>
                        <td width="595" height="35">&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td width="595" height="35"><img src="../<?php echo $LinkRestful['logourl'];?>"></td>
                    </tr>
                    <tr>
                        <td width="101" height="100" align="center" valign="middle">网站简介：</td>
                        <td width="347" height="100" align="center"><label>
                                <textarea name="intro" cols="40" rows="10">
                                        <?php echo $LinkRestful['intro'];?>
                                </textarea>
                            </label></td>
