...
$ScWhere = array(
    'table' => 'article',
    'field' => '*',
    'where'=>"author="."'{$helper->getUsernames()['username']}' AND id=".@$_GET['id'],
);
...
<div class="main-box-top">
    ...
    <div class="main">
        ...
        <div class="main-center" style="width: 80%;">
            ...
            <form action="../public/Article.class.php?tab=ArticleEdi&id=<?php echo $SaRestful['id'];?>" method="post" name="myform" onSubmit="return test();">
                <fieldset>
                    <legend>帖子信息:</legend>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                        <tr>
                            ...
                            <td  width="30%"><input type="text" name="title" size="30" value="<?php echo $SaRestful['title'];?>"></td>
...
<!--                        </tr>-->
                        <tr>
                            ...
                            <td  width="30%"><input type="text" name="com" size="30" value="<?php echo $SaRestful['com'];?>"></td>
                            <td  width="32%" height="30" align="right">&nbsp;</td>
